...
dlapp prometheus prometheus 2.23.0
...
#dlapp prometheus haproxy_exporter 0.11.0
#dlapp prometheus memcached_exporter 0.7.0
#dlapp prometheus mysqld_exporter 0.12.1
#dlapp prometheus node_exporter 1.0.1
#dlapp prometheus pushgateway 1.3.0
#dlapp prometheus statsd_exporter 0.18.0
dlapp prometheus-community bind_exporter 0.3.0
