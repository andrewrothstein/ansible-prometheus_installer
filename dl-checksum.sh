...
dlapp prometheus prometheus 2.37.0
#dlapp prometheus alertmanager 0.24.0
dlapp prometheus blackbox_exporter 0.21.1
#dlapp prometheus consul_exporter 0.8.0
dlapp prometheus graphite_exporter 0.12.2
...
dlapp prometheus statsd_exporter 0.22.6
dlapp prometheus statsd_exporter 0.22.7
